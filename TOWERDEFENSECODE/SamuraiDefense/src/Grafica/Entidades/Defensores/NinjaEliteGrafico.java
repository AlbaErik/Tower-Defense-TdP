...
public class NinjaEliteGrafico extends DefensorGrafico {
	private String palabras[] = { "NinjaEliteStanding", "NinjaEliteAttacking", "NinjaEliteDying","NinjaEliteStandingFuerza", "NinjaEliteAttackingFuerza" };

	public NinjaEliteGrafico(int x, int y, PanelMapa m, Defensor e) {
		super(x, y, m, e);
